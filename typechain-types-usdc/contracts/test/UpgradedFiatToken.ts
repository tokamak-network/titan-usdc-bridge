...
export interface UpgradedFiatTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface UpgradedFiatToken extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradedFiatToken;
  waitForDeployment(): Promise<this>;

  interface: UpgradedFiatTokenInterface;
