...
export interface V2UpgraderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "abortUpgrade"
      | "helper"
...
export interface V2Upgrader extends BaseContract {
  connect(runner?: ContractRunner | null): V2Upgrader;
  ...
  newName: TypedContractMethod<[], [string], "view">;
