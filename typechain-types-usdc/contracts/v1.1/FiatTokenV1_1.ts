...
export interface FiatTokenV1_1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface FiatTokenV1_1 extends BaseContract {
  connect(runner?: ContractRunner | null): FiatTokenV1_1;
  waitForDeployment(): Promise<this>;

  interface: FiatTokenV1_1Interface;
