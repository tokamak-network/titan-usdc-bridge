...
export interface UpgradedFiatTokenNewFieldsTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface UpgradedFiatTokenNewFieldsTest extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradedFiatTokenNewFieldsTest;
  waitForDeployment(): Promise<this>;

  interface: UpgradedFiatTokenNewFieldsTestInterface;
