...
export interface FiatTokenV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FiatTokenV2 extends BaseContract {
  connect(runner?: ContractRunner | null): FiatTokenV2;
