...
import { UsdcBridgeDeployer } from "./UsdcBridgeDeployer";
process.env.NODE_NO_WARNINGS = 'stream/web';

task("ton-and-tos-deploy", "Deploy the ton and tos")
    .addParam("l1Ton", "L1 TON Address")
    .addParam("l1Tos", "L1 TOS Address")
    .setAction(async ({l1Ton, l1Tos}) => {

        console.log("L1 ton", l1Ton)
        console.log("L1 tos", l1Tos)

        console.log("deploy ton ... ")

        // deployer = await ethers.getSigner(accounts.deployer);
        // const OptimismMintableERC20Factory_JSON = require('../artifacts-deploy/optimism/contracts/OptimismMintableERC20Factory.json')
        // const OptimismMintableERC20Factory_Address = "0x4200000000000000000000000000000000000012"
        ...
        // const OptimismMintableERC20Factory = await ethers.getContractAt(
        //     OptimismMintableERC20Factory_JSON.json,
        //     OptimismMintableERC20Factory_Address,
        // )
        // console.log("deploy tos ... ")
});
...
task("usdc-deploy", "Deploy the bridged usdc")
    ...
    .setAction(async (args, hre) => {
        const [actor] = await hre.ethers.getSigners();
        const contracts = await UsdcBridgeDeployer.deployBridgedUsdc(actor, args.adminAddress);
