...
export interface UpgradedFiatTokenV2_2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface UpgradedFiatTokenV2_2 extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradedFiatTokenV2_2;
  waitForDeployment(): Promise<this>;

  interface: UpgradedFiatTokenV2_2Interface;
