...
export interface MockFiatTokenWithEditableChainIdInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface MockFiatTokenWithEditableChainId extends BaseContract {
  connect(runner?: ContractRunner | null): MockFiatTokenWithEditableChainId;
  waitForDeployment(): Promise<this>;

  interface: MockFiatTokenWithEditableChainIdInterface;
