...
export interface FiatTokenV2_1Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FiatTokenV2_1 extends BaseContract {
  connect(runner?: ContractRunner | null): FiatTokenV2_1;
