...
export interface UpgradedFiatTokenNewFieldsNewLogicTestInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
  ...
  encodeFunctionData(
    functionFragment: "setNewAddress",
    values: [AddressLike]
  ): string;
...
export interface UpgradedFiatTokenNewFieldsNewLogicTest extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): UpgradedFiatTokenNewFieldsNewLogicTest;
  waitForDeployment(): Promise<this>;

  interface: UpgradedFiatTokenNewFieldsNewLogicTestInterface;
  ...
  setNewAddress: TypedContractMethod<
    [_newAddress: AddressLike],
    [void],
    "nonpayable"
  >;
